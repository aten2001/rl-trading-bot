...
def getBenchmark(shares=1000, sd=dt.date(2010,1,1), ed=dt.date(2011,12,31), symbol=['JPM']):
...
if __name__ == '__main__':
    ...
    benchmark = getBenchmark(shares=1000, sd=start_date, ed=end_date, symbol=['JPM'])
